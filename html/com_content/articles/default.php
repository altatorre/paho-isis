			...
			<table class="table table-striped" id="articleList">
					...
					<tr>
						...
						<th style="min-width:100px" class="nowrap">
							<?php echo JHtml::_('searchtools.sort', 'JGLOBAL_TITLE', 'a.title', $listDirn, $listOrder); ?>
								<?php // cambios para reorganizar las visualizaciones de las columnas  ?>
							<span class="nowrap hidden-phone">
							/ <?php echo JHtml::_('searchtools.sort',  'JGRID_HEADING_ACCESS', 'a.access', $listDirn, $listOrder); ?></span>
							<?php if ($assoc) : ?>
								<?php $columns++; ?>
								<span width="5%" class="nowrap hidden-phone">
									/ <?php echo JHtml::_('searchtools.sort', 'COM_CONTENT_HEADING_ASSOCIATION', 'association', $listDirn, $listOrder); ?>
								</span>
							<?php endif; ?>
							<span width="10%" class="nowrap hidden-phone">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
						...
						<td class="center"><!-- checkbox seleccion -->
						...
						<td class="has-context">
							<div class="pull-left break-word"><!-- titulo -->
							...
							<span class="small hidden-phone">
								Access: <?php echo $this->escape($item->access_level); ?></span>
							<?php if ($assoc) : ?>
								<?php if ($item->association) : ?>
									<br />
									<span  class="hidden-phone">(Assoc: <?php echo JHtml::_('contentadministrator.association', $item->id); ?>)</span>
								<?php endif; ?>
							<?php endif; ?>
							| 
							<span class="small hidden-phone">Author: 
